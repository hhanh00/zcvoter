...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1366234687;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiGetElectionPath({required String hash});

  Future<int> crateApiElectionGetLatestHeight({required String lwd});

  Future<int> crateApiElectionGetOrchardHeight();

  Future<String> crateApiElectionGetVotingAddress({required String hash});
  ...
  bool crateApiElectionIsValidAddress({required String address});

  bool crateApiElectionIsValidSeed({required String seed});

  Future<List<ElectionRec>> crateApiElectionListElections();

  Future<List<VoteRec>> crateApiElectionListVotes({required String hash});

  Future<void> crateApiElectionRemoveElection({required String hash});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Stream<CreateElectionResult> crateApiElectionCreateElection(
    ...
    unawaited(handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiElectionCreateElectionConstMeta,
      argValues: [progress, name, start, end, question, answers, lwd],
      apiImpl: this,
    )));
    return progress.stream;
  }

  TaskConstMeta get kCrateApiElectionCreateElectionConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiGetElectionPath({required String hash}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiGetElectionPathConstMeta,
      argValues: [hash],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiGetElectionPathConstMeta => const TaskConstMeta(
        debugName: "get_election_path",
        argNames: ["hash"],
      );
  ...
  Future<int> crateApiElectionGetLatestHeight({required String lwd}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiElectionGetLatestHeightConstMeta,
      argValues: [lwd],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiElectionGetLatestHeightConstMeta =>
      const TaskConstMeta(
  ...
  Future<int> crateApiElectionGetOrchardHeight() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiElectionGetOrchardHeightConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiElectionGetOrchardHeightConstMeta =>
      const TaskConstMeta(
        debugName: "get_orchard_height",
        argNames: [],
      );
  ...
  Future<String> crateApiElectionGetVotingAddress({required String hash}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiElectionGetVotingAddressConstMeta,
      argValues: [hash],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiElectionGetVotingAddressConstMeta =>
      const TaskConstMeta(
        debugName: "get_voting_address",
        argNames: ["hash"],
      );
  ...
  bool crateApiElectionIsValidAddress({required String address}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiElectionIsValidAddressConstMeta,
      argValues: [address],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiElectionIsValidAddressConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<VoteRec>> crateApiElectionListVotes({required String hash}) {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_vote_rec,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiElectionListVotesConstMeta,
      argValues: [hash],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiElectionListVotesConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiElectionRemoveElection({required String hash}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiElectionRemoveElectionConstMeta,
      argValues: [hash],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiElectionRemoveElectionConstMeta =>
      const TaskConstMeta(
        debugName: "remove_election",
        argNames: ["hash"],
      );
  ...
  Future<String> crateApiElectionVoteElection(
    ...
    return handler.executeNormal(NormalTask(
      ...
      argValues: [hash, address, amount, choice],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiElectionVoteElectionConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["hash", "address", "amount", "choice"],
      );
  ...
  List<VoteRec> dco_decode_list_vote_rec(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_vote_rec).toList();
  }
  ...
  VoteRec dco_decode_vote_rec(dynamic raw) {
    ...
    return VoteRec(
      ...
      choice: dco_decode_opt_box_autoadd_u_32(arr[4]),
    );
  }
  ...
  List<VoteRec> sse_decode_list_vote_rec(SseDeserializer deserializer) {
    ...
    var ans_ = <VoteRec>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_vote_rec(deserializer));
    }
    return ans_;
  }
  ...
  void sse_encode_list_vote_rec(List<VoteRec> self, SseSerializer serializer) {
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_vote_rec(item, serializer);
    }
  }
